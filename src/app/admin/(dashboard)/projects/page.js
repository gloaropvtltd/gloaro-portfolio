...
const fields = [
  ...
  { name: "link", label: "Link", type: "text", defaultValue: "#" },
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-h2 text-foreground">Projects</h1>
          <p className="mt-1 text-muted">Manage the Featured Projects section.</p>
        </div>
        <Button
          variant="primary"
          size="sm"
